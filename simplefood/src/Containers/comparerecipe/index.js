    ...
    const CompareRecipe = (props) => {
            ...
            return (
              <>
                {data1.map((recipe, index)=>{
                  return (<Col md={4} key={index} className="px-3">
                    <RecipesCard
                      index={index}
      ...
      return(
        <Wrapper>
        <div className={`${flag1 === false || flag2 === false ? "nodata-height" : ""}`}>
            ...
            <Row className="justify-content-center">
              <Col md={6} className="border-right">
                <Form onSubmit={handleSearch1}>
                  <FormGroup className="justify-content-center" row>
                    <Col md={10}>
                      <Input value={query1} onChange={handleQuery1} placeholder="Enter Recipe Name Here"/>
                      <FormText
                        className={`${data1.length === 0 && flag1 === true ? "" : "d-none"}`}
                      >
                        No recipes found with that name, please enter a different recipe name.
                      </FormText>
                    </Col>
              ...
              <Col md={6}>
                <Form onSubmit={handleSearch2}>
                  <FormGroup className="justify-content-center" row>
                    <Col md={10}>
                      <Input value={query2} onChange={handleQuery2} placeholder="Enter Recipe Name Here"/>
                      <FormText
                        className={`${data2.length === 0 && flag2 === true ? "" : "d-none"}`}
                      >
                        No recipes found with that name, please enter a different recipe name.
                      </FormText>
                    </Col>
